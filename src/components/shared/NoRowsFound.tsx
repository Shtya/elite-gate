...
export default function NoRowsFound({ message = "لا توجد بيانات لعرضها" }: { message?: string }) {
    return (
        <div className="py-10 text-center text-gray-500 text-sm flex flex-col items-center justify-center gap-4 ">
